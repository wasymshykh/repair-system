...
<body class="page-loading-enabled page-loading <?=isset($print_class)&&$print_class?'print-content-only':''?> header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
