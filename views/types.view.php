        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
            ...
            <tbody class="fw-bold text-gray-600">
                ...
                <tr>
                    ...
                    <td>
                        <span class="d-none" data-kt-ecommerce-category-filter="category_id"><?=$type['item_type_id']?></span>
                        <a href="<?=href('types_edit.php?i='.$type['item_type_id'], false)?>" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name"><?=$type['item_type_name']?></a>
                        <div class="text-muted fs-7 fw-bolder"><?=$type['item_type_description']?></div>
                    </td>
                    <td>
                        <?php if ($type['item_type_status'] == 'published'): ?>
