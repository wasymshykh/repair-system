...
<div class="card card-flush">
    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-toolbar">
            <a href="<?=href('users_create')?>" class="btn btn-primary">Add User</a>
        </div>
    </div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
            ...
            <tbody class="fw-bold text-gray-600">
                ...
                <tr>
                    ...
                    <td>
                        <span class="d-none" data-kt-ecommerce-category-filter="category_id"><?=$user['user_id']?></span>
                        <a href="<?=href('users_edit.php?i='.$user['user_id'], false)?>" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name"><?=$user['user_name']?></a>
                        <div class="text-muted fs-7 fw-bolder"><?=$user['user_email']?></div>
                    </td>
                    <td>
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            <div class="menu-item px-3">
                                <a href="<?=href('users_edit.php?i='.$user['user_id'], false)?>" class="menu-link px-3">Edit</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="<?=href('users_logs.php?i='.$user['user_id'], false)?>" class="menu-link px-3">Logs</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="<?=href('users.php?d='.$user['user_id'], false)?>" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row">Delete</a>
                            </div>
                        </div>
                    </td>
                </tr>
